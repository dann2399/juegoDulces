...
function ArrayDulces(arrayType, index) {
	...
	var ColDulce1 = $('.col-1').children();
	var ColDulce2 = $('.col-2').children();
	var ColDulce3 = $('.col-3').children();
	var ColDulce4 = $('.col-4').children();
	var ColDulce5 = $('.col-5').children();
	var ColDulce6 = $('.col-6').children();
	var ColDulce7 = $('.col-7').children();

	var ColDulces = $([ColDulce1, ColDulce2, ColDulce3, ColDulce4,
		ColDulce5, ColDulce6, ColDulce7
	]);

	if (typeof index === 'number') {
		var candyRow = $([ColDulce1.eq(index), ColDulce2.eq(index), ColDulce3.eq(index),
			ColDulce4.eq(index), ColDulce5.eq(index), ColDulce6.eq(index),
			ColDulce7.eq(index)
		]);
	} else {
		index = '';
...
function candyRows(index) {
	var candyRow = ArrayDulces('rows', index);
	return candyRow;
}

// arreglos de colunmnas
function ColDulces(index) {
	var candyColumn = ArrayDulces('columns');
